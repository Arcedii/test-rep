...
public class PlayerMoveController : MonoBehaviour {
    ...
    void FixedUpdate()
    {
		myVector = (_rigidbody.transform.position + (transform.forward * leftController.GetTouchPosition.y * Time.deltaTime * speedMovements) +
		   (transform.right * leftController.GetTouchPosition.x * Time.deltaTime * speedMovements));
		_rigidbody.MovePosition(myVector);
